  ...
  <div data-custom-class="body">
        ...
        ><strong
          ><span style="font-size: 15px"
            ><span data-custom-class="subtitle"
              >Last updated <bdt class="question">December 13, 2022</bdt>
            </span></span
          ></strong
        ></span
      >
      ...
      <span style="color: rgb(127, 127, 127)"
        ><span style="color: rgb(89, 89, 89); font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            <bdt class="question"
              >Foodlinic<bdt class="block-component"></bdt>
            </bdt>
            ...
            '<strong>our</strong>'<bdt class="else-block"></bdt> </span
          ><span data-custom-class="body_text"
    ...
    <div>
        ...
        <span style="font-size: 15px"
          ><span style="color: rgb(127, 127, 127)"
            ><span data-custom-class="body_text"
              ...
              <bdt class="question">foodlinic@gmail.com</bdt>.</span
            ></span
          ></span
        >
      </div>
      ...
      <div style="line-height: 1.5">
        <span style="font-size: 15px"
          ><span data-custom-class="body_text"
            ...
            <bdt class="question">Foodlinic</bdt>
      ...
      <div style="line-height: 1.5">
        ...
        ><a
          data-custom-class="link"
          href="https://app.termly.io/notify/d1819885-2e02-4eed-8899-c025ac25e4af"
              ...
              ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                  ><span data-custom-class="body_text"
                    ...
                    <bdt class="question"
                      ><a
                        href="https://www.paypal.com/se/webapps/mpp/ua/privacy-full?locale.x=en_SE"
                        target="_blank"
                        data-custom-class="link"
                        >https://www.paypal.com/se/webapps/mpp/ua/privacy-full?locale.x=en_SE</a
                      > </bdt
                    ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                      ><span style="font-size: 15px; color: rgb(89, 89, 89)"
                        ><span data-custom-class="body_text"
                                                                ...
                                                                <span
                                                                  ...
                                                                  >
                                                                    <bdt
                                                                      class="question"
                                                                      ><a
                                                                        href="https://foodlinic.com/cookie-policy"
                                                                        target="_blank"
                                                                        data-custom-class="link"
                                                                        >https://foodlinic.com/cookie-policy</a
                                                                      >
                                                                    </bdt>
                                                                  </span></span
                                                                ><span
